...
function PopupEdu() {
  return (
    <>
      <div style={{ display: "block", position: "fixed", zIndex: 100, left: 0, top: 0, width: "100%", height: "100%", backgroundColor: "rgba(0,0,0,0.4)" }}>
        <div style={{ display: "flex", flexDirection: "column", height: "100%", alignItems: "center" }}>
          <div style={{ height: 50 }} />
          <div style={{ width: 500, display: "flex", color: "#fff", fontSize: 24, fontWeight: "bold", textAlign: "center" }}>
            <div style={{ width: 50 }} />
            <span style={{ flex: 1 }}>현장 일보 :: 협업사 모아보기</span>
            <div
              style={{ width: 50 }}
              onClick={(e) => {
